...
devidADP2440     = c_int(16)
devidADP2450     = c_int(17)
...
DwfParamDigitalThreshold= c_int(15) # mV
DwfParamFanTemp         = c_int(16) # *C temperature set
DwfParamFanMin          = c_int(17) # RPM 0 default
DwfParamFanMax          = c_int(18) # RPM
DwfParamDigFrequency    = c_int(19) # Hz
DwfParamFanDuty         = c_int(20) # m%
DwfParamCompFreq        = c_int(21) # Hz compensation output
DwfParamCompDuty        = c_int(22) # m% compensation output
DwfParamFanCtrl         = c_int(23) # 0 default, 1 duty, 2,3,4,5 temperature sensors
DwfParamSleep           = c_int(24) # seconds, idle time for device shutdown
DwfParamDACFrequency    = c_int(25) # Hz
